            ...
            {loading ? (
              ...
              <>
                ...
                <div className="space-y-2 rounded-lg border p-3 bg-muted/30">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="grid gap-1.5 md:col-span-2">
                      <Label htmlFor="edit_vicidial_server_ip">Vicidial Server IP / Hostname</Label>
                      <Input
                        id="edit_vicidial_server_ip"
                        placeholder="e.g. 192.168.100.5 or dialer.theircompany.com"
                        value={form.server_ip}
                        onChange={(e) => setForm((f) => ({ ...f, server_ip: e.target.value }))}
                        required
                    ...
                    <div className="grid gap-1.5">
                      <Label htmlFor="edit_vicidial_sip_ext">SIP Extension</Label>
                      <Input
                        id="edit_vicidial_sip_ext"
                        placeholder="e.g. 1001"
                        value={form.sip_extension}
                        onChange={(e) => setForm((f) => ({ ...f, sip_extension: e.target.value }))}
                        required
                    ...
                    <div className="grid gap-1.5">
                      <Label htmlFor="edit_vicidial_sip_pass">SIP Password</Label>
                      <Input
                        id="edit_vicidial_sip_pass"
                        type="password"
                        placeholder="SIP Password"
                        value={form.sip_password}
                        onChange={(e) => setForm((f) => ({ ...f, sip_password: e.target.value }))}
                ...
                <div className="space-y-2 rounded-lg border p-3 bg-muted/30">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="grid gap-1.5">
                      <Label htmlFor="edit_vicidial_api_user">API User</Label>
                      <Input
                        id="edit_vicidial_api_user"
                        placeholder="e.g. 6666"
                        value={form.api_user}
                        onChange={(e) => setForm((f) => ({ ...f, api_user: e.target.value }))}
                        required
                    ...
                    <div className="grid gap-1.5">
                      <Label htmlFor="edit_vicidial_api_pass">API Password</Label>
                      <Input
                        id="edit_vicidial_api_pass"
                        type="password"
                        placeholder="API Password"
                        value={form.api_password}
                        onChange={(e) => setForm((f) => ({ ...f, api_password: e.target.value }))}
                    ...
                    <div className="grid gap-1.5">
                      <Label htmlFor="edit_vicidial_campaign">Campaign ID</Label>
                      <Input
                        id="edit_vicidial_campaign"
                        placeholder="e.g. TESTCAMP"
                        value={form.campaign_id}
                        onChange={(e) => setForm((f) => ({ ...f, campaign_id: e.target.value }))}
                        required
                    ...
                    <div className="grid gap-1.5">
                      <Label htmlFor="edit_vicidial_list">List ID</Label>
                      <Input
                        id="edit_vicidial_list"
                        placeholder="e.g. 999"
                        value={form.list_id}
                        onChange={(e) => setForm((f) => ({ ...f, list_id: e.target.value }))}
                        required
                ...
                <div className="grid gap-3">
                  <div className="grid gap-1.5">
                    <Label htmlFor="edit_vicidial_phone">Phone Number / ID</Label>
                    <Input
                      id="edit_vicidial_phone"
                      placeholder="e.g. +15551234567 or 1001"
                      value={form.phone_number}
                      onChange={(e) => setForm((f) => ({ ...f, phone_number: e.target.value }))}
                      required
                  ...
                  <div className="grid gap-1.5">
                    <Label htmlFor="edit_vicidial_label">Label</Label>
                    <Input
                      id="edit_vicidial_label"
                      placeholder="e.g. Support Line, Sales Line..."
                      value={form.label}
                      onChange={(e) => setForm((f) => ({ ...f, label: e.target.value }))}
                    />
                  ...
                  <div className="grid gap-1.5">
                    <Label htmlFor="edit_vicidial_assistant">Linked Assistant</Label>
                    <Select
                      value={form.assistant_id || "__none__"}
                      onValueChange={(v) =>
                        setForm((f) => ({ ...f, assistant_id: v === "__none__" ? "" : v }))
                    ...
                    >
                      <SelectTrigger id="edit_vicidial_assistant">
                        <SelectValue placeholder="Select an assistant…" />
                      </SelectTrigger>
                      <SelectContent>
